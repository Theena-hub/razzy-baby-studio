...
$query = "SELECT * FROM tbl_event WHERE status = 1 ORDER BY id asc";
...
<body class="  ">
    ...
    <div id="overlay">
        <div id="popup">
            <h3 class="text-center col-blue mb-2">Add Event Banner</h3>
            <form id='addEvent' enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label class="form-label" for="image">Event Banner</label>
    ...
    <div id="overlay" class="editoverlay">
        <div id="popup" class="editpopup">
            <h3 class="text-center col-blue mb-2">Edit Event Banner</h3>
            <form id='editEvent' enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label class="form-label" for="editimage">Event Banner</label>
