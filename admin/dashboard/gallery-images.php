...
WHERE tbl_gallery_images.status = 1 ORDER BY id DESC;";
$result = mysqli_query($conn, $query);
$galleryImagesData = mysqli_fetch_all($result, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <?php foreach ($galleryImagesData as $data): ?>
                                    <div class="col-md-4 col-12">
                                        <div class="card p-3" style="background: #E6F5F6;">
                                            <h5 class="text-center mb-2">
                                                <?= $data['service_name']; ?>
                                            </h5>
                                            <img class="img-fluid m-auto" style="height: 200px"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#addImage').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'backend/backend-gallery-image.php',
                    data: formData,
                    contentType: false,
