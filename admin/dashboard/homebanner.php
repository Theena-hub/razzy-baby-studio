...
$query = "SELECT tbl_homebanner.*, tbl_service.name AS service_name
FROM tbl_homebanner
JOIN tbl_service ON tbl_homebanner.redirect = tbl_service.id
WHERE tbl_homebanner.status = 1 ORDER BY id ASC;";
$result = mysqli_query($conn, $query);
$homebannerData = mysqli_fetch_all($result, MYSQLI_ASSOC);
// fetch services data from the db
$queryService = "SELECT * FROM tbl_service WHERE status = 1 ORDER BY id DESC";
$resultService = mysqli_query($conn, $queryService);
$serviceData = mysqli_fetch_all($resultService, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
...
<body class="  ">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <?php foreach ($homebannerData as $data): ?>
                                    <div class="col-md-6 col-12">
                                        <div class="card p-3" style="background: #E6F5F6;">
                                            ...
                                            <!--<h6 class="text-center mt-2 d-flex justify-content-end">-->
                                            <!--    Page Redirect to = <?= $data['service_name'] ?>-->
                                            <!--</h6>-->
    ...
    <div id="overlay">
        <div id="popup">
            <h3 class="text-center col-blue mb-2">Add Banner</h3>
            <form id='addBanner'>
                <div class="row">
                    <div class="col-md-6 col-12">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label for="redirect">Page Redirect</label>
                            <select id="redirect" name="redirect" class="form-select"
                                aria-label="Default select example" required>
                                <option value="" disabled hidden selected>Select Page Redirection</option>
    ...
    <div id="overlay" class="editoverlay">
        <div id="popup" class="editpopup">
            <h3 class="text-center col-blue mb-2">Edit Banner</h3>
            <form id='editBanner' enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label for="editservice">Page Redirect</label>
                            <select id="editservice" name="editservice" class="form-select"
                                aria-label="Default select example" required>
                                <?php foreach ($serviceData as $service): ?>
                                    <option value="<?= $service['id'] ?>" <?= ($service['id'] == $data['redirect']) ? 'selected' : ''; ?>>
                                        <?= $service['name'] ?>
                                    </option>
                                <?php endforeach; ?>
                                <option value="#">Others</option>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#addBanner').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'backend/backend-homebanner.php',
                    data: formData,
                    contentType: false,
            ...
            $('.edit-btn').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        // Populate the options for the redirect dropdown
                        $('#editservice').val(data.redirect);
