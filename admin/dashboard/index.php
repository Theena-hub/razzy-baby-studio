...
$query = "SELECT tbl_home_images.*, tbl_service.name AS service_name
FROM tbl_home_images
JOIN tbl_service ON tbl_home_images.service_id = tbl_service.id
WHERE tbl_home_images.status = 1 order by id asc;";
$result = mysqli_query($conn, $query);
$homeImagesData = mysqli_fetch_all($result, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
...
<body class="  ">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    <h1>Home Page Project Images</h1>
                                </div>
                                <div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <?php foreach ($homeImagesData as $data): ?>
                                    <div class="col-md-4 col-12">
                                        <div class="card p-3" style="background: #E6F5F6;">
                                            ...
                                            <a style="position: absolute;leftt:0;bottom:0"
    ...
    <div id="overlay" class="editoverlay">
        <div id="popup" class="editpopup">
            <h3 class="text-center col-blue mb-2">Edit Image</h3>
            <form id='editData'>
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#addImage').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'backend/backend-home-image.php',
                    data: formData,
                    contentType: false,
            ...
            $('.edit-btn').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        var selectedServiceId = result.data.service_id;
                        
                        // Set the selected service in the dropdown
                        $('#editservice').val(selectedServiceId);
