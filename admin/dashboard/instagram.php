...
$query = "SELECT * FROM tbl_instagram WHERE status = 1 ORDER BY id DESC";
$result = mysqli_query($conn, $query);
$instagramData = mysqli_fetch_all($result, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
...
<body class="  ">
                                ...
                                foreach ($instagramData as $data):
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="card p-3" style="background: #E6F5F6;">
                                            <img class="img-fluid m-auto" style="width:100%;height: 220px"
    ...
    <div id="overlay">
        <div id="popup">
            <h3 class="text-center col-blue mb-2">Add Posts</h3>
            <form id='addPost'>
                <div class="row">
    ...
    <div id="overlay" class="editoverlay">
        <div id="popup" class="editpopup">
            <h3 class="text-center col-blue mb-2">Edit Posts</h3>
            <form id='editPost' enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label class="form-label" for="editimage">Post Image</label>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#addPost').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'backend/backend-instagram.php',
                    data: formData,
                    contentType: false,
