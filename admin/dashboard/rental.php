...
$rentalData = mysqli_fetch_all($result, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
...
<body class="  ">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <?php foreach ($rentalData as $data): ?>
                                    <div class="col-md-6 col-12">
                                        <div class="card p-3" style="background: #E6F5F6;border:none">
                                            <img class="img-fluid m-auto" style="width:100%;height: 250px"
                                                src="uploads/<?= $data['image']; ?>" alt="banner">
                                            <a target="_blank" href="uploads/documents/<?= $data['document'] ?>">
                                                <h5 class="text-center mx-2 mt-2">
                                                    <?= $data['document'] ?>
                                                </h5>
                                            </a>
    ...
    <div id="overlay">
        <div id="popup">
            <h3 class="text-center col-blue mb-2">Add Rental Record</h3>
            <form id='addRental'>
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label class="form-label" for="image">Rental Image</label>
    ...
    <div id="overlay" class="editoverlay">
        <div id="popup" class="editpopup">
            <h3 class="text-center col-blue mb-2">Edit Rental Record</h3>
            <form id="editRentalForm" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <label for="edit_document_name" class="form-label">PDF Document</label>
                            <input type="file" class="form-control" name="edit_document_name" id="edit_document_name"
                                accept=".pdf">
                            <input type="hidden" name="edit_document_name_old" id="edit_document_name_old" value="">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label for="edit_image_name" class="form-label">Rental Image</label>
                            <div class="input-group">
                                <input type="file" class="form-control" name="edit_image_name" id="edit_image_name"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#addRental').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'backend/backend-rental.php',
                    data: formData,
                    contentType: false,
                    processData: false,
            ...
            $('.edit-btn').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#edit_image_name').text(data.image);
                        // Set the document name in the modal
                        $('#edit_document_name').text(data.document);
                        // $('#edit_document_name_old').val(data.document);
