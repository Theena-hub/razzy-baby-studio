...
<body class="  ">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="card p-3" style="background: #E6F5F6;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <img class="img-fluid m-auto" style="width:100%;height: 200px"
                                                        src="uploads/<?= $data['image_two']; ?>" alt="banner">
                                                </div>
                                            </div>
    ...
    <div id="overlay">
        <div id="popup">
            <h3 class="text-center col-blue mb-2">Add Service</h3>
            <form id='addService'>
                <div class="row">
                    <div class="col-md-6 col-12">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label class="form-label" for="image2">Banner</label>
                            <input type="file" class="form-control" name="image2" id="image2" required
                                onchange="imagePreview(this,'bannerPreview2')">
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <img id="bannerPreview2" src="" alt="Product Image"
                                style="max-width: 100%; max-height: 200px; display: none;">
                        </div>
                    </div>
                </div>
    ...
    <div id="overlay" class="editoverlay">
        <div id="popup" class="editpopup">
            <h3 class="text-center col-blue mb-2">Edit Service</h3>
            <form id='editService'>
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label class="form-label" for="editimage2">Banner</label>
                            <input type="file" class="form-control" name="editimage2" id="editimage2" accept="image/*"
                                onchange="imagePreview(this,'edit_image_preview2')">
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="form-group">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#addService').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'backend/backend-services.php',
                    data: formData,
                    contentType: false,
            ...
            $('.edit-btn').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        var imagePath2 = result.data.image_two;
                        ...
                        $('#edit_image_preview2').attr('src', 'uploads/' + imagePath2);
                        $('#edit_image_preview2').css('display', 'block');
