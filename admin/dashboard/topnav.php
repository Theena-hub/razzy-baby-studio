        ...
        <a href="../dashboard/index.php" class="navbar-brand">
            ...
            <div class="logo-main">
                <div class="logo-normal">
                    <img class="text-primary icon-30" src="../assets/images/favicon.png" alt="Favicon"/>
            ...
            <!--logo End-->
            <h4 class="logo-title">Razzybabys   tudio</h4>
        </a>
                ...
                <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button"
                        ...
                        <div class="caption ms-3 d-none d-md-block ">
                            <h6 class="mb-0 text-uppercase caption-title"><?php echo $_SESSION['userName']; ?></h6>
